...
func goto_scene(path):
	...
	the_player()
	state_of_scene()
	#stops the music of the current scene
...
#saves the node of the player on the current scene 
func the_player():
...
# changes the spawn for the next scene, so the character starts at the right position on the area
